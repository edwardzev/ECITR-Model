...
const DEFAULT_BENCHMARK_MANIFEST = path.join(
  ...
  "fixtures",
  "benchmarks",
  "invariant-discovery-benchmark.example.json",
);

function runInvariantDiscoveryBenchmark({
  ...
  const surface = new InvariantDiscoverySurface({ catalogRoot });
...
module.exports = {
  ...
  runInvariantDiscoveryBenchmark,
};
